...
export const guides: Guide[] = [
  {
    ...
    sections: [
      ...
      {
        h2: "Long distance from Manchester",
        body: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Weight can fill a van before space does",
        body: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Insurance: ask about the limits",
        body: [
      ...
      {
        h2: "Questions to ask before you book either",
        body: [
  ...
  },
  {
    ...
    sections: [
      {
        h2: "Book the lift and loading bay early",
        body: [
      ...
      {
        h2: "Measure the access, not just the rooms",
        body: [
      ...
      {
        h2: "A simple pre-move checklist",
        body: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h2: "Loading on yellow lines and in loading bays",
        body: [
      ...
      {
        h2: "Permit zones and the clean air question",
        body: [
