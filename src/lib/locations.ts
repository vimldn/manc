...
export const locations: Location[] = [
  {
    ...
    title: "Man and Van in Manchester City Centre (M1, M4) | Man and Van Manchester",
    metaDescription:
  ...
  },
  {
    ...
    title: "Man and Van in Salford (M5, M6) | Man and Van Manchester",
    metaDescription:
    ...
    intro:
      "Man and van in Salford covers a real mix, from the terraces of Ordsall and Pendleton to the new apartments near the river and out towards Eccles. Man and Van Manchester works right across Salford, and being just across the water from the city centre we are often here within the hour. Whatever the property, we turn up on time and get it done without fuss.",
    local: [
  ...
  },
  {
    ...
    title: "Man and Van in Didsbury (M20) | Man and Van Manchester",
    metaDescription:
    ...
    intro:
      "Man and van in Didsbury tends to mean family homes, Victorian semis and the odd tricky staircase. Man and Van Manchester covers West Didsbury, East Didsbury and the village, moving everything from a full family house to a single wardrobe. We look after period furniture properly, because a lot of Didsbury homes are full of it.",
    local: [
  ...
  },
  {
    ...
    title: "Man and Van in Chorlton (M21) | Man and Van Manchester",
    metaDescription:
    ...
    intro:
      "Man and van in Chorlton usually means terraced houses, young families and the busy streets around Beech Road and Chorlton Green. Man and Van Manchester covers all of M21, moving households, single items and Marketplace pickups across this popular corner of south Manchester. We know the streets, so parking and access do not catch us out.",
    local: [
  ...
  },
  {
    ...
    title: "Man and Van in Fallowfield (M14) | Man and Van Manchester",
    metaDescription:
    ...
    intro:
      "Man and van in Fallowfield is student territory, and we know it inside out. Man and Van Manchester covers all of M14, handling halls to house share moves, room swaps and the end of tenancy scramble around Wilmslow Road. It is the cheap, reliable man and van locals and students in Fallowfield actually call.",
    local: [
  ...
  },
  {
    ...
    title: "Man and Van in Withington (M20) | Man and Van Manchester",
    metaDescription:
    ...
    intro:
      "Man and van in Withington covers a mix of students and young professionals, with terraced streets running off Wilmslow Road. Man and Van Manchester handles flat moves, house shares and single item deliveries across the area. It sits between Fallowfield and Didsbury, so we know the roads and the parking well.",
    local: [
  ...
  },
  {
    ...
    title: "Man and Van in Old Trafford (M16) | Man and Van Manchester",
    metaDescription:
    ...
    intro:
      "Man and van in Old Trafford means terraces, apartments and, on the wrong day, football and cricket crowds. Man and Van Manchester covers all of M16, and we always check the fixture list before we quote a match day move so parking and access are planned, not a nasty surprise.",
    local: [
  ...
  },
  {
    ...
    title: "Man and Van in Hulme (M15) | Man and Van Manchester",
    metaDescription:
      "Man and van in Hulme. Student and apartment moves near the universities in M15 at cheap, fair prices. Call for a quote.",
    intro:
      "Man and van in Hulme is a lot of student and young professional moves, given how close it is to the universities and the city centre. Man and Van Manchester covers M15, handling apartment moves, house shares and single item runs quickly and cheaply. We know the modern blocks and the access around them.",
    local: [
  ...
  },
  {
    ...
    title: "Man and Van in Wythenshawe (M22) | Man and Van Manchester",
    metaDescription:
  ...
  },
  {
    ...
    title: "Man and Van in Cheetham Hill (M8) | Man and Van Manchester",
    metaDescription:
  ...
  },
  {
    ...
    title: "Man and Van in Prestwich (M25) | Man and Van Manchester",
    metaDescription:
    ...
    intro:
      "Man and van in Prestwich means a lot of family homes and semis in the leafy suburb near Heaton Park. Man and Van Manchester covers M25, handling house removals, flat moves and single item deliveries. It is a popular spot for families, which keeps us busy with full household moves.",
    local: [
  ...
  },
  {
    ...
    title: "Man and Van in Stretford (M32) | Man and Van Manchester",
    metaDescription:
    ...
    intro:
      "Man and van in Stretford covers the area between Manchester and Trafford, close to the tram line and the Trafford Centre. Man and Van Manchester handles house removals, flat moves and single item runs across M32. Good tram and road links make it an easy area for us to reach and move around.",
    local: [
  ...
  },
  {
    ...
    title: "Man and Van in Sale (M33) | Man and Van Manchester",
    metaDescription:
    ...
    intro:
      "Man and van in Sale means family homes, semis and a well connected Trafford suburb on the tram line. Man and Van Manchester covers M33, handling full house removals, flat moves and single item deliveries. Sale is a popular family area, so household moves are our bread and butter here.",
    local: [
  ...
  },
  {
    ...
    title: "Man and Van in Salford Quays (M50) | Man and Van Manchester",
    metaDescription:
    ...
    intro:
      "Man and van in Salford Quays is almost all apartment moves, given the towers around MediaCity and the waterfront. Man and Van Manchester covers M50, and we plan every job around the goods lifts, concierge desks and timed loading bays that come with modern blocks. Tell us the building and floor and we will handle the rest.",
    local: [
